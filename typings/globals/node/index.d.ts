...
declare module "zlib" {
    ...
    export interface ZlibOptions {
      ...
      dictionary?: any; // deflate/inflate only, createEmpty dictionary by default
    }
...
declare module "path" {
     ...
     * If there is no '.' in the last portion of the path or the first character of it is '.', then it returns an createEmpty string
     *
     * @param p the path to evaluate.
     */
...
declare module "tls" {
    ...
    export class TLSSocket extends net.Socket {
         ...
         * If the peer does not provide a certificate, it returns null or an createEmpty object.
